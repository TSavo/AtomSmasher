  ...
  fetchRequestFromCwd() {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      for (const registry of (0, (_keys || _load_keys()).default)((_index2 || _load_index2()).registries)) {
        ...
        const pushDeps = function pushDeps(depType, _ref, isUsed) {
          let hint = _ref.hint,
          ...
          for (const name in depMap) {
            ...
            deps.push({ pattern: pattern, registry: registry, hint: hint, optional: optional });
          }
        };
  ...
  bailout(patterns) {
    ...
    return (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* () {
      ...
      if (_this2.flags.frozenLockfile && !_this2.lockFileInSync(patterns)) {
        _this2.reporter.error(_this2.reporter.lang('frozenLockfileError'));
        return true;
      }
